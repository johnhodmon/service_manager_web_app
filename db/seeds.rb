...
job6=Job.create(reported_fault:"Ring not working",status:'allocated',allocation_date:'2016-04-16');
job7=Job.create(reported_fault:"Nothing working on cooker",status:'allocated',allocation_date:'2016-04-16');
job8=Job.create(reported_fault:"Machine full of water",status:'allocated',allocation_date:'2016-04-16');
job9=Job.create(reported_fault:"Machine leaking",status:'complete',allocation_date:'2016-04-16');
